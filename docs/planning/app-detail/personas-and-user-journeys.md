# Workflow And Automation Studio Personas And User Journeys
...
| ---: | --- | --- | --- |
| 1 | Model process states, transitions, timers, dependencies, assignments, and exception paths. | App validates context, permissions, dependencies, and lifecycle state. | App-owned record, event, task, projection, or handoff is updated. |
| 2 | Define rules for eligibility, routing, approval, prioritization, risk, SLA, fallout, and automation. | App validates context, permissions, dependencies, and lifecycle state. | App-owned record, event, task, projection, or handoff is updated. |
| 3 | Manage work queues, manual tasks, evidence, comments, due dates, and escalation. | App validates context, permissions, dependencies, and lifecycle state. | App-owned record, event, task, projection, or handoff is updated. |
| 4 | Define automation playbooks with triggers, preconditions, actions, rollback, approvals, and safety constraints. | App validates context, permissions, dependencies, and lifecycle state. | App-owned record, event, task, projection, or handoff is updated. |
| 5 | Configure journeys, forms, page flows, validations, data extensions, and lightweight workflows with lifecycle governance. | App validates context, permissions, dependencies, and lifecycle state. | App-owned record, event, task, projection, or handoff is updated. |

## Persona Journeys

## Persona Journey 1: Process owner

Need: models business and operational workflows.

Typical journey:

1. Opens the app from a work queue, customer/account context, operational dashboard, external notification, or direct search.
2. Reviews relevant records, relationships, history, policy flags, and open exceptions across modules such as Process Definition, Rules And Decision, Work Queue And Task, Automation And Intent.
...
## Persona Journey 2: Automation engineer

Need: builds playbooks, event triggers, actions, and safety rules.
...
## Persona Journey 3: Business operations user

Need: manages rules, routing, approvals, and exception queues.
...
## Persona Journey 4: Platform admin

Need: governs configuration and extensions.
...
## Persona Journey 5: QA/release manager

Need: validates workflow and rule changes before release.
...
The app should support journeys that cross these modules: Process Definition, Rules And Decision, Work Queue And Task, Automation And Intent, Configuration And Extension Studio.
