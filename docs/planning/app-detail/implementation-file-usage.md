# Workflow And Automation Studio Implementation File Usage

Reviewed: 2026-06-14

## Purpose

Use this guide when building `Workflow And Automation Studio`. It explains which generated files matter, when to read them, and how they drive Angular, Spring Boot, PostgreSQL, TMF API, event, and privacy work.

## App Identity

| Item | Value |
| --- | --- |
| Suite | 06 Enterprise Platform, Data, And Governance |
...
| App overview | [../workflow-automation-studio.md](../workflow-automation-studio.md) | Concise product scope, app purpose, TMF API usage, ownership, integrations, and first-release direction. |
...
| App TMF review | [../../tmf-api-ddl-reviews/workflow-automation.md](../../tmf-api-ddl-reviews/workflow-automation.md) | TMF APIs, resource-to-table mapping, field handling, event baseline, privacy/retention/audit baseline. |
| Suite V001 migration | [../../../../database/postgres/suites/ts_enterprise_platform_governance/V001__create_app_schemas_and_starter_tables.sql](../../../../database/postgres/suites/ts_enterprise_platform_governance/V001__create_app_schemas_and_starter_tables.sql) | Creates suite schemas, starter app tables, base controls, and outbox tables. |
| App V002+ migration | [../../../../database/postgres/suites/ts_enterprise_platform_governance/V005__refine_workflow_automation_tmf_core.sql](../../../../database/postgres/suites/ts_enterprise_platform_governance/V005__refine_workflow_automation_tmf_core.sql) | Promotes common TMF columns and creates app support tables, event_contract, and privacy_retention_policy. |
...
9. Use `workflow_automation.event_contract` as the baseline event register and `workflow_automation.event_outbox` for publication.
10. Use `workflow_automation.privacy_retention_policy` as the baseline for masking, audit, retention, legal hold, and residency handling.
...
- Write only inside schema `workflow_automation` for this app's operational data.
