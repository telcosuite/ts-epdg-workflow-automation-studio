...
- Default scaffold targets are defined in P01 for GitHub app repository `ts-epdg-workflow-automation-studio` and include app-root `frontend/`, `backend/`, `contracts/openapi/v1/openapi.yaml`, `contracts/events/`, `database/postgres/migrations/`, `database/postgres/seeds/`, `.github/workflows/`, `deploy/compose/`, `deploy/k8s/`, `deploy/helm/`, `docs/`, `OWNERS.md`, `CODEOWNERS`, local dev scripts, and copied `dev-tasks/`.
...
- App writes stay inside `workflow_automation`; cross-app collaboration must use APIs, events, workflow tasks, governed projections, or data products.
- TMF review status: Complete (see `docs/planning/tmf-api-to-ddl-review.md` for the full V001/V00X baseline rationale); DDL baseline status: Complete; starter tables: see `database/postgres/source-migrations/V005__refine_workflow_automation_tmf_core.sql`.

## Discovered Phase Summary

| Phase | Phase file | Rationale | Exit gate | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| P01 - From Scratch App Foundation And Delivery Runtime | [P01-from-scratch-app-foundation-and-delivery-runtime.md](P01-from-scratch-app-foundation-and-delivery-runtime.md) | Bootstrap GitHub app repository `ts-epdg-workflow-automation-studio` and app-root runtime before feature implementation because planning has no runnable app implementation. | Clean checkout of `ts-epdg-workflow-automation-studio` can run the frontend/backend, migrate the app schema, validate Docker Compose and Kubernetes/Helm, run CI smoke checks, and prove the first UI/API/database/audit-event vertical slice. | Not Started | Updated to align with app-repo strategy. |
| P02 - Phase 2 Foundation | [P02-phase-2-foundation.md](P02-phase-2-foundation.md) | Build the first feature-area foundation specific to Workflow Automation Studio before the next set of capability slices can be built. | First feature-area foundation in `workflow_automation` is testable against the V001/V00X migrations and TMF-aligned APIs. | Not Started | Generated from source feature pack. |
| P03 - Phase 3 Expansion | [P03-phase-3-expansion.md](P03-phase-3-expansion.md) | Expand the first feature area and connect to the second feature area specific to Workflow Automation Studio. | Second feature area is testable and emits or consumes the first feature area's events. | Not Started | Generated from source feature pack. |
| P04 - Phase 4 Cross Area | [P04-phase-4-cross-area.md](P04-phase-4-cross-area.md) | Wire cross-area handoffs, lifecycle transitions, and downstream events for Workflow Automation Studio. | Cross-area handoffs and event publication are tested end to end. | Not Started | Generated from source feature pack. |
| P05 - Phase 5 Release Readiness | [P05-phase-5-release-readiness.md](P05-phase-5-release-readiness.md) | Complete release-gate evidence, observability, runbooks, and support handoff for Workflow Automation Studio. | App release evidence covers privacy, audit, observability, accessibility, support, and post-launch monitoring. | Not Started | Generated from source feature pack. |

## From-Scratch Build Artifact Checklist

| Artifact area | Default target | Completion evidence |
| --- | --- | --- |
| GitHub app repository | `ts-epdg-workflow-automation-studio` | Repository exists with `README.md`, `OWNERS.md`, `CODEOWNERS`, branch protection, required checks, security scanning, and copied `dev-tasks/` from planning. |
...
| PostgreSQL | `database/postgres/migrations/` and `database/postgres/seeds/` | Clean app-repo migration run, app-owned tables for schema `workflow_automation`, idempotency/audit/outbox, seed/demo data, and rollback/repair notes. |
...
| --- | --- | --- | --- | --- |
| [automation-and-intent](../planning/app-detail/features/automation-and-intent.md) | `features/automation-and-intent.md` | derived | P02-P05 | Not Started |
| [automation-safety-task-calendar-and-rule-simulation](../planning/app-detail/features/automation-safety-task-calendar-and-rule-simulation.md) | `features/automation-safety-task-calendar-and-rule-simulation.md` | derived | P02-P05 | Not Started |
| [configuration-and-extension-studio](../planning/app-detail/features/configuration-and-extension-studio.md) | `features/configuration-and-extension-studio.md` | derived | P02-P05 | Not Started |
| [cross-app-journey-templates-and-saga-compensation](../planning/app-detail/features/cross-app-journey-templates-and-saga-compensation.md) | `features/cross-app-journey-templates-and-saga-compensation.md` | derived | P02-P05 | Not Started |
| [process-definition](../planning/app-detail/features/process-definition.md) | `features/process-definition.md` | derived | P02-P05 | Not Started |
| [process-mining-and-action-adapter-governance](../planning/app-detail/features/process-mining-and-action-adapter-governance.md) | `features/process-mining-and-action-adapter-governance.md` | derived | P02-P05 | Not Started |
| [rules-and-decision](../planning/app-detail/features/rules-and-decision.md) | `features/rules-and-decision.md` | derived | P02-P05 | Not Started |
| [work-queue-and-task](../planning/app-detail/features/work-queue-and-task.md) | `features/work-queue-and-task.md` | derived | P02-P05 | Not Started |
